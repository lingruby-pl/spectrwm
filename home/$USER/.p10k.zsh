# Generated by Powerlevel10k configuration wizard on 2021-03-15 at 02:44 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,SUDO}_EXPANSION='%B%n'
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%a %d %b %Y ─ %H%M%S}'
